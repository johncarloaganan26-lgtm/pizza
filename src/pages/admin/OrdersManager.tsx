    ...
    <div id="orders-manager">
      <header className="mb-16">
        ...
        <h1 className="text-4xl font-black tracking-tighter uppercase leading-none text-brand-dark dark:text-white">
          Active <br />
          <span className="font-thin italic lowercase tracking-normal text-brand-red/40">& Orders.</span>
        </h1>
      </header>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div className="bg-white dark:bg-zinc-900 p-8 border border-brand-red/5 dark:border-white/5 rounded-sm flex items-center gap-6 shadow-sm">
          <div className="p-4 bg-orange-50 dark:bg-orange-500/10 text-orange-600 rounded-sm"><Flame className="w-6 h-6" /></div>
          <div>
            <p className="text-[10px] uppercase font-black tracking-widest text-brand-red/20 dark:text-white/20">Cooking</p>
        ...
        <div className="bg-white dark:bg-zinc-900 p-8 border border-brand-red/5 dark:border-white/5 rounded-sm flex items-center gap-6 shadow-sm">
          ...
          <div>
            <p className="text-[10px] uppercase font-black tracking-widest text-brand-red/20 dark:text-white/20">Delivering</p>
        ...
        <div className="bg-white dark:bg-zinc-900 p-8 border border-brand-red/5 dark:border-white/5 rounded-sm flex items-center gap-6 shadow-sm">
          ...
          <div>
            <p className="text-[10px] uppercase font-black tracking-widest text-brand-red/20 dark:text-white/20">Completed Today</p>
      ...
      <div className="bg-white dark:bg-zinc-900 border border-brand-red/5 dark:border-white/5 rounded-sm overflow-hidden shadow-sm">
        <div className="p-8 border-b border-brand-red/5 dark:border-white/5 flex justify-between items-center bg-brand-cream/10 dark:bg-zinc-800">
          ...
          <div className="flex gap-4">
            ...
            <button className="text-[8px] font-black uppercase tracking-widest px-4 py-2 border border-brand-red/10 dark:border-white/10 text-brand-red dark:text-white/60 rounded-sm hover:bg-brand-red/5 transition-colors">Export Orders</button>
          </div>
        </div>
        <div className="divide-y divide-brand-red/5 dark:divide-white/5">
          {[1,2,3,4,5,6].map(i => (
            <div key={i} className="p-8 flex items-center justify-between hover:bg-brand-cream/30 dark:hover:bg-zinc-800/50 transition-colors">
              <div className="flex items-center gap-10">
                <div className="text-center w-20">
                  <p className="text-[10px] font-black uppercase text-brand-red/20 dark:text-white/20 tracking-widest mb-1">ID</p>
                  <p className="text-xs font-black text-brand-dark dark:text-white">#ART-{5000 + i}</p>
                </div>
                <div className="h-10 w-[1px] bg-brand-red/5 dark:bg-white/5" />
                <div>
                  <p className="text-xs font-black uppercase mb-1 text-brand-dark dark:text-white">Customer Name (Member)</p>
                  <p className="text-[10px] text-brand-red/40 dark:text-white/40 uppercase tracking-widest">3 Items • $74.50 • Delivery to Location</p>
                </div>
              </div>
              <div className="flex items-center gap-12 text-zinc-900 dark:text-white">
                <div className="text-right">
                  <p className="text-[10px] font-black uppercase text-brand-red/20 dark:text-white/20 tracking-widest mb-1">Duration</p>
